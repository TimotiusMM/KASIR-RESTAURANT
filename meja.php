                ...
                <tbody>
                    ...
                    ?>
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-<?php echo ($row['statusMeja'] == 1) ? 'success' : 'danger'; ?> btn-sm status-btn" data-id="<?php echo $row['idMeja']; ?>" data-status="<?php echo $row['statusMeja']; ?>">
                                        <?php echo ($row['statusMeja'] == 1) ? 'Aktif' : 'Tidak Aktif'; ?>
                                    </button>
                                </td>
                                <td>
                                    <button type="button" class="btn btn-warning btn-sm edit-btn"
                                     onclick="window.location.href='editMeja.php?idMeja=<?php echo $row['idMeja']; ?>'" data-id="<?php echo $row['idMeja']; ?>" data-nama="<?php echo $row['kodeMeja']; ?>" data-harga="<?php echo $row['keterangan']; ?>">Edit</button>
                                    <!-- Modal Delete -->
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="hapusMeja.php?idMeja=<?php echo $row['idMeja']; ?>" class="btn btn-danger btn-circle">
...
statusButtons.forEach(function(button) {
    ...
    button.addEventListener('click', function() {
        ...
        .then(function(data) {
            ...
            button.innerHTML = (newStatus == 1) ? 'Aktif' : 'Tidak Aktif';
