...
if(isset($_POST['submit'])) {
    ...
    if($result) {
        // Redirect kembali ke halaman order setelah mengedit
                        ...
                        <div class="form-floating mb-3">
                            <select class="form-select" id="idPelanggan" name="idPelanggan">
                                ...
                                while($row_pelanggan = mysqli_fetch_assoc($result_pelanggan)) {
                                    if($row_pelanggan['idPelanggan'] == $idPelanggan) {
                                        echo "<option value='".$row_pelanggan['idPelanggan']."' selected>".$row_pelanggan['namaPelanggan']."</option>";
                                    } else {
                        ...
                        <div class="form-floating mb-3">
                            <select class="form-select" id="idMenu" name="idMenu">
                                ...
                                while($row_menu = mysqli_fetch_assoc($result_menu)) {
                                    if($row_menu['idMenu'] == $idMenu) {
                                        echo "<option value='".$row_menu['idMenu']."' selected>".$row_menu['namaMenu']."</option>";
                                    } else {
                        ...
                        <div class="form-floating mb-3">
                            <select class="form-select" id="idMeja" name="idMeja">
                                ...
                                while($row_meja = mysqli_fetch_assoc($result_meja)) {
                                    if($row_meja['idMeja'] == $idMeja) {
                                        echo "<option value='".$row_meja['idMeja']."' selected>".$row_meja['kodeMeja']."</option>";
                                    } else {
                        ...
                        <div class="form-floating mb-3">
                            <select class="form-select" id="idUser" name="idUser">
                                ...
                                while($row_user = mysqli_fetch_assoc($result_user)) {
                                    if($row_user['idUser'] == $idUser) {
                                        echo "<option value='".$row_user['idUser']."' selected>".$row_user['namaUser']."</option>";
                                    } else {
