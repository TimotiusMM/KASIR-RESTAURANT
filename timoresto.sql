...
--
-- Host: localhost:3306
-- Generation Time: Mar 21, 2024 at 09:17 AM
...
--
ALTER TABLE `meja`
  MODIFY `idMeja` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `pesanan`
  MODIFY `idPesanan` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
